    ...
    <fildset><legend><h3 align=center>Добавить пользователя</h3></legend>
        <table style="border-collapse: collapse; width: 100%; height: 57px;">
            <tbody>
                ...
                <td style="width: 50%; height: 21px;"><input type="text" name="login" value="<%out.println(user.getLogin());%>" size="50%&quot;" /></td>
                </tr>
                <tr style="height: 18px;">
                <td style="width: 50%; text-align: right; height: 18px;">Password&nbsp;</td>
                <td style="width: 50%; height: 18px;"><input type="text" name="password" value="<%out.println(user.getPassword());%>" size="50%&quot;" /></td>
                </tr>
                <tr style="height: 18px;">
                ...
                <td style="width: 50%; text-align: right; height: 58px;"><input type="submit" value="Добавить" formaction="../add_edit_user" /></td>
